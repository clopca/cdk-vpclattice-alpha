...
export interface DefaultListenerAction {
   ...
   * @default - None
   */
  readonly fixedResponse?: HTTPFixedResponse;
  /**
...
export interface RuleProp {
   ...
   */
  readonly action: HTTPFixedResponse | WeightedTargetGroup[];
  /**
 ...
 *
 */
export abstract class ListenerBase extends core.Resource implements IListener {
  /**
